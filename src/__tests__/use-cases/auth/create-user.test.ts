...
describe("Create User Use Case", () => {
  ...
  it("should throw AuthError when Cognito registration fails", async () => {
    ...
    await expect(createUserUseCase(mockUserData)).rejects.toThrow("Failed to register user");
  ...
  it("should throw UseCaseError when repository creation fails", async () => {
    ...
    await expect(createUserUseCase(mockUserData)).rejects.toThrow("Failed to create user");
  });
